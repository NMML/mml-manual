...
A completed NOAA Small Boat Operator and Crewmember Authorization Form (NOAA Form 57-19-04 (3-19)) is required for all SBOs & crew. This is reviewed and validated annually by the Vessel Operations Coordinator. The SBO requirement can also be met via a USCG Auxiliary (USCGA) Boating Skills and Seamanship (BS&S) or equivalent course. Ask MML Operations Management for a list of resources.
