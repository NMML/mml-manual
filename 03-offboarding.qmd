...
Access to your [webTA](https://www.commerce.gov/hr/employees/compensation/webta) profile will be deprovisioned after your webTA timekeeper, Tammy Ahlers, marks your last timesheet as ‘final’, typically within 14 days or one pay period of your separation date.    

## Turning in Equipment

Ensure any lab equipment (e.g. computer and peripherals) you have been using has been returned to the lab, office furniture is present and accounted for, and that tagged equipment has been logged in with the [MML Property Manager](https://sites.google.com/noaa.gov/myafsc/administrative/property-management), AJ Renney for non-IT property and Jon French for IT property. Make sure any problems with equipment are documented and that the MML Property Manager and Program Lead have been made aware of them.  

## MML Library

Return all books and reprints checked out from the MML library. Work with Sonja Kromann to ensure all materials are accounted for.  

## Key Card and Office Keys

Key card access to WRC facilities will be terminated (_find out if this is the last day onsite_). Office keys should be returned to MML Admin staff, Mary Foote. 
