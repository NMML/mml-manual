...
To reserve aviation drysuits for a project, use the [Aviation Drysuit Schedule](https://docs.google.com/spreadsheets/d/1ai4B0oY7uNZ490zJEFgdh12kaRNWO80JBwicHcIDV_Y/edit#gid=0). Use the previous year's tab to see reservation conventions for various projects.
...
| Online Commerce Learning Center [(CLC) Courses](https://doc.csod.com/catalog/CustomPage.aspx?id=20000416) |   annually    |                       | Recommended for contracted transport flights to/from remote field sites.<br><br>Courses include:<ul><li>NOAA Aviation Policy & Procedures</li><li>Basic Aviation Safety & Survival</li><li>Aviation Health</li><ul> |
